...
%% Sit to Stand, Unaffected Side, 3 Synergies
...
movementTitle = strrep(movements{move},"_"," ");
t.Title.String = "Minimum Synergies for Sit-to-Stand, Affected Side (EMG)";
t.Title.FontWeight = 'bold';
t.Title.FontSize = 16;
t.TileSpacing = "tight";
t.Padding = "tight";
...
filename = "min_synergies_s2s_affected_side_EMG";
filename = fullfile(figDir,filename);
savefig(filename)
